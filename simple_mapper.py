...
def map_financial_data(financial_data, matrix):
    ...
    system_prompt = f"""YOU ARE A FINANCIAL DATA EXPERT - YOUR TASK IS TO FILL IN AS MANY CELLS AS POSSIBLE IN A FINANCIAL MATRIX
...
#### JUST REMEBR TO ADD ALL NECCESSARY YEARS TO THE MATRIX AS HEADERS IN DATE RELATED ROWS ABOVE THE NUMBER OF MONTHS IF ANY #####
